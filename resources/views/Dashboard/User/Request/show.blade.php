            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <a href="{{ route('user.request.create') }}" class="btn btn-primary">Add Budget</a>
                            </div>
                            <div class="col-md-6 text-end">
                                <form action="{{ route('user.request.search', ['department_code' => $department_code]) }}"
                                        ...
                                        @else
                                            @foreach ($requests as $request)
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('user.request.edit', ['request' => $request->request_code]) }}"
                                                        ...
                                                        <form
                                                            action="{{ route('user.request.destroy', ['request' => $request->request_code]) }}"
