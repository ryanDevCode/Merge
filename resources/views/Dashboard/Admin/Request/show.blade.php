            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <a href="{{ route('admin.request.create') }}" class="btn btn-primary">Add Budget</a>
                            </div>
                            <div class="col-md-6 text-end">
                                <form action="{{ route('admin.request.search', ['department_code' => $department_code]) }}"
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        @foreach ($statuses as $status)
                                                            @if ($status->status_code == $request->request_status)
                                                                {{ $status->status_name }}
                                                            @endif
                                                        @endforeach
                                                    </td>
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('admin.request.edit', ['request' => $request->request_code]) }}"
                                                        ...
                                                        <form
                                                            action="{{ route('admin.request.destroy', ['request' => $request->request_code]) }}"
