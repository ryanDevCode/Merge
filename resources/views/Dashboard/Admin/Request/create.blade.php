...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <form action="{{ route('admin.request.store', ['department_code' => $department_code]) }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" name="request_request_code" required="">
                                        <option value="" selected disabled>Select Budget</option>
                                        @foreach ($budgets as $budget)
                                            <option value="{{ $budget->id }}">{{ $budget->request_name }}
                                             </option>
                                        @endforeach
                                    </select>
                                    <div class="valid-feedback">Done!</div>
