            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <a href="{{ route('user.budget.create') }}" class="btn btn-primary">Add Budget</a>
                            </div>
                            <div class="col-md-6 text-end">
                                <form action="{{ route('user.budget.search', ['department_code' => $department_code]) }}"
                                        ...
                                        @else
                                            @foreach ($budgets as $bdgt)
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('user.budget.edit', ['budget' => $bdgt->id]) }}"
                                                        ...
                                                        <form action="{{ route('user.budget.destroy', $bdgt->id) }}"
